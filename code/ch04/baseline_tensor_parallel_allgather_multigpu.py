...
PROFILE_NVTX_RANGE = "compute_kernel:tensor_parallel_allgather_reference"
...
class BaselineTensorParallelAllGatherBenchmark(VerificationPayloadMixin, BaseBenchmark):
    ...
    def get_torchrun_spec(self, config: Optional[BenchmarkConfig] = None) -> TorchrunLaunchSpec:
        ...
        return TorchrunLaunchSpec(
            ...
            script_args=["--module", "ch04.baseline_tensor_parallel_allgather_multigpu", "--callable", "main", "--"],
            multi_gpu_required=True,
