...
class NVSHMEMTrainingExampleMultiGPU(
    NVSHMEMChildResultMixin,
    ...
    def get_config(self) -> BenchmarkConfig:
        if "RANK" in os.environ and "WORLD_SIZE" in os.environ:
            return BenchmarkConfig(
                ...
                nsys_nvtx_include=[TRAINING_EXAMPLE_BASELINE_NVTX_RANGE],
    ...
    def get_torchrun_spec(self, config: Optional[BenchmarkConfig] = None) -> TorchrunLaunchSpec:
        ...
        return TorchrunLaunchSpec(
            ...
            env={
                **result_env,
                "AISP_NVSHMEM_PIPELINE_REUSE_BUFFERS": "0",
                PROFILE_NVTX_RANGE_ENV: TRAINING_EXAMPLE_BASELINE_NVTX_RANGE,
            },
            multi_gpu_required=True,
