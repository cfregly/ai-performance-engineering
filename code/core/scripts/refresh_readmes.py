...
ENTRIES["labs/README.md"] = Entry(
    ...
    extra_sections=[
        dedent(
            ...
            | `labs/fast_cu/` | H100 GEMM, a full B200 K64 NVFP4 port, reduction and epilogue experiments, and all GB300 NVFP4 examples. See the [chapter mapping](fast_cu/optimization_guide.md) | ch09, ch10, ch11, ch14 |
