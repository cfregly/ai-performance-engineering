...
def coerce_input_signature(sig: Union[InputSignature, Dict[str, Any]]) -> InputSignature:
    ...
    signature = InputSignature(
        ...
        collective_algorithm=sig.get("collective_algorithm"),
        gradient_bucket_bytes=sig.get("gradient_bucket_bytes"),
        barrier_policy=sig.get("barrier_policy"),
        async_completion_policy=sig.get("async_completion_policy"),
