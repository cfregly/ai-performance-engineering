...
class OptimizedNvfp4DualGemmBenchmark(VerificationPayloadMixin, BaseBenchmark):
    ...
    def setup(self) -> None:
        ...
        self.output = None
        self._shape_signature = torch.empty(5, dtype=torch.int64)
        self._shape_signature[0] = self.m
        self._shape_signature[1] = self.n
    ...
    def benchmark_fn(self) -> None:
        ...
        with torch.inference_mode(), self._nvtx_range("optimized_nvfp4_dual_gemm"):
