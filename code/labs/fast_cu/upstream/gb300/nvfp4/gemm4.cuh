...
// First widen the baseline store while retaining its default cache policy.
static __device__ __forceinline__ void st_global_b256(
        void* ptr, uint4 lo, uint4 hi) {
    asm volatile("st.global.v8.b32 [%0], "
                 "{%1, %2, %3, %4, %5, %6, %7, %8};"
